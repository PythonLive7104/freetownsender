...
const STEPS = [
  ...
  },
  {
    ...
    body: "On the Auto-reply page, craft the templates EndTime sends. Drop in your placeholders, and optionally attach files. These are the bodies your rules will send.",
    to: "/auto-reply",
    cta: "Open Auto-reply",
  },
  {
  ...
  },
  {
    icon: "attachments",
    title: "6. Attachments",
    lead: "Files to send with a reply.",
    body: "Upload reusable files here once, then attach them to a rule so they go out with that rule's reply.",
    to: "/attachments",
